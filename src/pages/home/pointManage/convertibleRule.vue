  ...
  <div class="convertible_rule" style="height:100%;">
		<el-row>
            <div class="searchBox-wrapper">
                <div class="searchName">兑换目标平台:<span></span></div>
        ...
        <el-row>
            <el-col>
                <el-table :data="tableData" stripe border style="width: 100%">
                    <el-table-column prop="name" label="兑换平台">
                    </el-table-column>
                    <el-table-column prop="tag" label="兑换规则标识">
                    </el-table-column>
                    <el-table-column prop="point" label="本系统积分" >
                    </el-table-column>
                    <el-table-column prop="describe" label="兑换平台积分">
                    </el-table-column>
                    <el-table-column prop="status" label="启用开关" width="95" align="center">
                    </el-table-column>
                    <el-table-column prop="creattime" label="说明" width="100" align="center">
                    </el-table-column>
