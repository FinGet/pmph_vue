            ...
            <el-table-column
                ...
                <template scope="scope">
                     <el-tooltip class="item" effect="dark" content="发布" placement="bottom">
                        <i class="fa fa-paper-plane-o table_i grey_icon" :class="{active_green:scope.row.isPublish}" ></i>
                    </el-tooltip>
                    <el-tooltip class="item" effect="dark" content="审核" placement="bottom">
                        <i class="fa fa-check-square-o table_i grey_icon" :class="{active_orange:scope.row.isExam}" ></i>
                    </el-tooltip>
                    ...
                    <el-tooltip class="item" effect="dark" content="推荐" placement="bottom">
                        <i class="fa fa-eye-slash table_i grey_icon" :class="{active_hide:scope.row.isHide}" ></i>
                    </el-tooltip>
                </template>
            </el-table-column>
            <el-table-column
