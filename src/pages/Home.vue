    ...
    methods: {
      ...
      initIsShowBorder(){
       // console.log(this.$router.currentRoute);
        ...
        if(str=='user'&&this.$router.currentRoute.name!='社内用户'||this.$router.currentRoute.name=='文章管理'||str=="topic"||this.$router.currentRoute.name=='问卷模板新增'||this.$router.currentRoute.name=='调查结果统计'||this.$router.currentRoute.name=='发起调查'){
          this.isPadding=true;
        }
