    ...
    <el-dialog :visible.sync="dialogVisible" size="large" top="30px">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="社内用户" name="second">
          <el-row>
            <el-col :span="6">
              <el-tree :data="data" :props="defaultProps" @node-click="handleNodeClick" node-key="id" :default-expanded-keys="[1]"></el-tree>
            </el-col>
            <el-col :span="17" :offset="1">
              ...
              <el-pagination class="pull-right" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="[100, 200, 300, 400]" :page-size="100" layout="total, sizes, prev, pager, next, jumper" :total="400">
              </el-pagination>
            </el-col>
          </el-row>
    ...
    getGroupMember(val){
      ...
      this.$axios.get(this.groupMemberUrl, {
        ...
        if (res.data.code == 1) {
          ...
          _this.writerPageTotal= res.data.data.pageTotal;
        }
      })
    },
    /* 获取作家用户列表 */
